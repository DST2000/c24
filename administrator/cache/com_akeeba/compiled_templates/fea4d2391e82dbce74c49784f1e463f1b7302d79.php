<?php /* D:\OPS\OSPanel\domains\1c24\administrator\components\com_akeeba\tmpl\ConfigurationWizard\wizard.blade.php */ ?>
<?php
/**
...
<div id="akeeba-confwiz">
    ...
    <div id="backup-progress-pane">
        <div class="akeeba-block--warning">
            <?php echo \Joomla\CMS\Language\Text::_('COM_AKEEBA_CONFWIZ_INTROTEXT'); ?>
        </div>

        <fieldset id="backup-progress-header">
            <h3>
                <?php echo \Joomla\CMS\Language\Text::_('COM_AKEEBA_CONFWIZ_PROGRESS'); ?>
            </h3>
            <div id="backup-progress-content">
                <div id="backup-steps">
                    <div id="step-minexec" class="akeeba-label--grey">
                        <?php echo \Joomla\CMS\Language\Text::_('COM_AKEEBA_CONFWIZ_MINEXEC'); ?>
                    </div>
                    <div id="step-directory" class="akeeba-label--grey">
                        <?php echo \Joomla\CMS\Language\Text::_('COM_AKEEBA_CONFWIZ_DIRECTORY'); ?>
                    </div>
                    <div id="step-dbopt" class="akeeba-label--grey">
                        <?php echo \Joomla\CMS\Language\Text::_('COM_AKEEBA_CONFWIZ_DBOPT'); ?>
                    </div>
                    <div id="step-maxexec" class="akeeba-label--grey">
                        <?php echo \Joomla\CMS\Language\Text::_('COM_AKEEBA_CONFWIZ_MAXEXEC'); ?>
                    </div>
                    <div id="step-splitsize" class="akeeba-label--grey">
                        <?php echo \Joomla\CMS\Language\Text::_('COM_AKEEBA_CONFWIZ_SPLITSIZE'); ?>
                    </div>
                </div>
    ...
    <div id="error-panel" class="akeeba-block--failure" style="display:none">
        <h2 class="alert-heading"><?php echo \Joomla\CMS\Language\Text::_('COM_AKEEBA_CONFWIZ_HEADER_FAILED'); ?></h2>
        <div id="errorframe">
    ...
    <div id="backup-complete" style="display: none">
        <div class="akeeba-block--success">
            <h2 class="alert-heading"><?php echo \Joomla\CMS\Language\Text::_('COM_AKEEBA_CONFWIZ_HEADER_FINISHED'); ?></h2>
            <div id="finishedframe">
                <p>
                    <?php echo \Joomla\CMS\Language\Text::_('COM_AKEEBA_CONFWIZ_CONGRATS'); ?>
                </p>
                <p>
                    <a
                    ...
                    <a
                            ...
                            href="<?php echo $this->escape(JUri::base()); ?>index.php?option=com_akeeba&view=Configuration">
